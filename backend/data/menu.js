const menuItems = {
  "Pizzas & Burgers": [
    ...
    { 
      ...
      price: 399,
      isVeg: true,
      description: "Loaded with fresh vegetables and paneer",
      category: "Italian",
      is_discounted: false,
    ...
    { 
      ...
      price: 449,
      isVeg: false,
      description: "Spicy pizza with premium pepperoni",
      category: "Italian",
      is_discounted: true,
    ...
    { 
      ...
      price: 199,
      isVeg: true,
      description: "Extra cheese with burst filling",
      category: "American",
      is_discounted: false,
      discount_amount: null,
      flavor_profile: ["savory", "creamy", "mild"]
    ...
    { 
      ...
      price: 299,
      isVeg: false,
      description: "Two meat patties with double cheese",
      category: "American",
      is_discounted: false,
      discount_amount: null,
  ...
  "Desserts & Beverages": [
    { 
      ...
      is_discounted: false,
      discount_amount: null,
      flavor_profile: ["sweet", "rich", "chocolatey"]
    },
    { 
      name: "Gulab Jamun",
      price: 99,
      ...
      is_discounted: true,
      discount_amount: "20% off",
      flavor_profile: ["sweet", "mild", "creamy"]
    },
    { 
      name: "Rasmalai",
      price: 129,
